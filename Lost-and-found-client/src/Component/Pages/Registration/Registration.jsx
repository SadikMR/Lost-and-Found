...
const Registration = () => {
    ...
    const handleSignUp = event => {
        ...
        const person = (fullname, username, email, password, confirmPassword, phone, division, zilla, upzilla, village);
        ...
        if (!fullname || !username || !email || !password || !confirmPassword || !phone || !division || !zilla || !upzilla || !village) {
        ...
        createUser(email, password)
            ...
            .catch(error => {
                alert("An occurred error durign registration " + error.message);
            });
    }
    return (
        <div className='bg-[#FAF7F0]'>
            <NavLink to="/" className='text-black mt-5 mx-5 text-2xl'>Home</NavLink>
            <div className="flex items-center justify-center">
                <div className="w-full max-w-md bg-[#EADBC8] rounded-lg shadow-lg p-8">
                    ...
                    {/* Form */}
                    <form onSubmit={handleSignUp} className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Full Name */}
                        <div>
